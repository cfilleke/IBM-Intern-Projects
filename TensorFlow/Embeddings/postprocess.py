...
class Postprocess:
    ...
    def test_dots(self):
        print(f'Standard dot product of \"audience\" and \"mission\": {self.dot("audience", "mission")}')
        for i in range(2,4):
            print(f'The {i}-polynomial kernel dot product of \"audience\" and \"mission\": {self.dot_kernel("audience", "mission", i)}\n')
    ...
    def test_cosines(self):
        print(f'Standard cosine similarity between \"audience\" and \"mission\": {self.sim_cos("audience", "mission")}')
        for i in range(2,4):
            print(f'The {i}-polynomial kernel cosine similarity between \"audience\" and \"mission\": {self.sim_cos_kernel("audience", "mission", i)} \n')
